...
```
Error: ENOENT: no such file or directory, stat 'D:\Playwright Demonstrations\number1_input.txt'
```
...
Call log:
  ...
  - waiting for locator('#addmessage')
    6 × locator resolved to <p class="mt-20" id="addmessage"></p>
      - unexpected value ""
...
```ts
  ...
  11 |     page.locator('#sum1').setInputFiles("number1_input.txt");
