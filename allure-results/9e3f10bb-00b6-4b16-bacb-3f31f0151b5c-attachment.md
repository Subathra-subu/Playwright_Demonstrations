...
```
Error: locator.click: SyntaxError: Failed to execute 'evaluate' on 'Document': The string '//button[@type='button'])[1])' is not a valid XPath expression.
...
Call log:
  - waiting for locator('//button[@type=\'button\'])[1])')
