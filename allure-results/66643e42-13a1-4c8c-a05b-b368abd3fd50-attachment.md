...
Locator: locator('#firstFr').contentFrame().locator('p.text-sm font-semibold text-center')
...
Call log:
  ...
  - waiting for locator('#firstFr').contentFrame().locator('p.text-sm font-semibold text-center')
