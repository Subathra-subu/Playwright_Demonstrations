      ...
      - generic:
        - generic [ref=e64]:
          ...
          - generic [ref=e86]:
            ...
            - textbox [active] [ref=e89]: Subathra
          - generic [ref=e90]:
                          ...
                          - generic [ref=f2e1256]:
                            ...
                            - generic [ref=f2e1325]:
                              ...
                              - generic [ref=f2e1329]:
                                ...
                                - strong [ref=f2e1340]: "7"
                                - strong [ref=f2e1343]: "9"
                                - strong [ref=f2e1346]: "2"
                                - strong [ref=f2e1349]: "7"
                                - strong [ref=f2e1352]: "0"
                          - table:
                            - rowgroup:
                              - row:
                                - cell
...
```ts
  ...
  7  |     console.log("Before fill('') usage:",await textbox.inputValue());
  8  |     await textbox.fill('');
  9  |     console.log("After fill('') usage:",await textbox.inputValue());
  10 | 
  11 |     await textbox.fill("Subathra");
> 12 |     expect(textbox.inputValue()).toBe("Subathra");
     |                                  ^ Error: expect(received).toBe(expected) // Object.is equality
  13 | })
```