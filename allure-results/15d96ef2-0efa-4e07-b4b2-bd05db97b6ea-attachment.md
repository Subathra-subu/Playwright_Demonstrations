...
Call log:
  ...
  - waiting for locator('#confirm-demo')
    11 × locator resolved to <p class="mt-20" id="confirm-demo"></p>
       - unexpected value ""
...
```ts
  ...
  10 |     })
  11 |     await page.locator("(//button[@type='button'])[2]").click();
> 12 |     await expect(page.locator('#confirm-demo')).toHaveText("You pressed OK!");
     |                                                 ^ Error: expect(locator).toHaveText(expected) failed
  13 | 
  14 | });
  15 | 
