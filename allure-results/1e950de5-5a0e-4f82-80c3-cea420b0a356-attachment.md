                          ...
                          - generic [ref=f2e1256]:
                            ...
                            - generic [ref=f2e1325]:
                              ...
                              - generic [ref=f2e1329]:
                                ...
                                - strong [ref=f2e1343]: "0"
                                - strong [ref=f2e1346]: "0"
                                - strong [ref=f2e1349]: "0"
                                - strong [ref=f2e1352]: "7"
                          - table:
                            - rowgroup:
                              - row:
                                - cell
        ...
        - complementary [ref=e254]:
          - generic [ref=e255]:
            ...
            - generic [ref=e290]:
              ...
              - button "GetPrompt" [active] [ref=e293]
            - generic [ref=e294]:
...
```ts
  ...
  10 |     })
  11 | 
  12 |     page.on('dialog',async(alert)=>{
  13 |         console.log(alert.message());
> 14 |         await alert.accept("Hiiii");
     |                     ^ Error: dialog.accept: Cannot accept dialog which is already handled!
  15 |     })
  16 |     
  17 |     await page.locator('#alert1').click();
  18 | 
  19 |     await page.locator('#prompt').click();
  20 | })
  21 | 
```